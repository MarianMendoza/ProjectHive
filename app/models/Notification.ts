...
export interface INotification extends Document {
  ...
  type: "Application" | "Invitation" | "Update" | "General" | "Closed"; // Type of notification
...
const NotificationSchema: Schema = new Schema({
  ...
  type: { type: String, enum: ["Application", "Invitation", "Update", "General", "Closed"], default: "General" }, // Type of notification
