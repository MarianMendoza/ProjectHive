    ...
    const handleSubmit = async (e: React.FormEvent) => {
      ...
      const updatedData = {
        ...
        projectAssignedTo: {
          ...
          studentsId: selectedStudents.map((id) => id),
        },
        ...
        <div className="w-full">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="mt-6 flex justify-end">
              <Link
                href="/pages/projects"
                className="bg-lime-600 text-white px-8 py-3 rounded-xl mx-10 hover:bg-lime-700 focus:outline-none focus:ring-2 focus:ring-lime-600"
              >
                Cancel
              </Link>
              <button
