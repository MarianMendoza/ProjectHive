  ...
  return (
    <div className="container mx-auto p-10 flex items-center justify-center ">
      <div className='w-full'>
        <h1 className="text-3xl font-semibold text-center text-gray-800 mb-8">Create New Project</h1>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-4">
            <label htmlFor="visibility" className="block text-gray-700 font-medium mb-2">Visibility</label>
            <select
              id="visibility"
              name="visibility"
          ...
          <div className="mb-4">
            <label htmlFor="files" className="block text-gray-700 font-medium mb-2">Files</label>
            <input
              type="text"
              id="files"
              name="files"
